...
/**
  *The name of the property under which we store if the P2PSIP protocol is used
  *@author Dong Fengyu
  */

     public static final String IS_P2PSIP_ENABLED ="IS_P2PSIP_ENABLED";

/**
  *The name of the property under which we store if the password will be checked
  *@author Dong Fengyu
  */

    public static final String IS_PASSCHECK_ENABLED ="IS_PASSCHECK_ENABLED";
