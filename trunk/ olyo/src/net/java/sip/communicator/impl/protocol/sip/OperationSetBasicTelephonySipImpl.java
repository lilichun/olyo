...
/**
  ...
  */
	...
	logger.info("protocolProvider.isP2PSIP()="+ protocolProvider.isP2PSIP() );


        /**
         * Added by Wangyao and Dong Fengyu
         */
	...
	if(protocolProvider.isP2PSIP()){
        ...
        for(Iterator it = resultSet.iterator(); it.hasNext();){
        	...
        	tempCall = createOutgoingCall(parseAddressStr(addrStrFromDHT));

        	if (null != tempCall){
        		logger.info("Setup a call to the address: "+addrStrFromDHT);
        		return tempCall;
        	}
        }
	}
