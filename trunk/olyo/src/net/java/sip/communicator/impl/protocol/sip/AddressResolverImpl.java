    ...
    implements AddressResolver
{
    ...
    public Hop resolveAddress(Hop inputAddress)
    {
    	/**
    	 * Added by WangYao.
    	 * If the inputAddress is in the format of "IP:port", 
    	 * then it is unnecessary to resolve it. 
    	 */
    	if (NetworkUtils.isDecimalDotFormatIPv4Addr(inputAddress.getHost())
    			&& NetworkUtils.isValidPort(inputAddress.getPort())){
    		return inputAddress;
    	}    	
